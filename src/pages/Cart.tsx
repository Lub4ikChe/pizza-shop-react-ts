...
export const Cart = () => {
    ...
    const { items, totalCount, totalPrice } = useSelector(getCartState);
    const pizzas: IPizzaItemInCart[] = Object.keys(items).map(key => {
        return items[key][0];
    });

    const hendleClearCart = (): void => {
                ...
                <div className="cart">
                    ...
                    <div className="cart__bottom">
                        <div className="cart__bottom-details">
                            <span> All pizzas: <b>{totalCount} items.</b> </span>
                    ...
                    <div className="cart cart--empty">
                        <h2>
                            Cart is empty <i> <span aria-label="sad" role="img">😕</span></i>
                        </h2>
